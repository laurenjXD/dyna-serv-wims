...
const SAMPLE_ITEMS = [
  {
    ...
    description: "Sample electronic components for testing the complete receiving flow.",
  ...
  },
  {
    ...
    description: "Sample trading item for pick and dispatch testing.",
  ...
  },
  {
    ...
    description: "Sample industrial supply for receiving and inspection testing.",
    itemType: "packaging",
    uom: "piece",
    currency: "PHP",
