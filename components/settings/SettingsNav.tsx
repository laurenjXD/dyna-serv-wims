...
export function SettingsNav() {
  ...
  return (
    <nav
      ...
      className="flex shrink-0 flex-row gap-1 overflow-x-auto border-b border-outline-variant/30 bg-surface-white p-2 md:w-56 md:flex-col md:border-b-0 md:border-r md:p-4"
    >
