...
| 1.4 | Receiving and inspection interface | 7/31 – 8/5 | 0% | `07-incoming-receiving`, `05-ui-shell` | **Draft** (requirements/design fully drafted; blocked on `02`/`03` approval (`01` approved 2026-08-05) and `db-migration-verifier`/`rbac-rls-reviewer`/design-system review per its own tasks.md gate) | Not Started (Blocked by Spec) |
