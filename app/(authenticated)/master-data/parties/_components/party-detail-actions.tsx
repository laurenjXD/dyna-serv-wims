      ...
      {canManage && (
        <form action={formAction}>
          ...
          <button
            ...
            className="ml-1 flex h-11 w-11 items-center justify-center rounded text-text-grey hover:text-brand-red focus:outline-none focus:ring-2 focus:ring-brand-red disabled:opacity-50"
          >
            ×
          </button>
        </form>
    ...
    >
      <div className="w-full max-w-lg rounded-md bg-surface-white shadow-elevation-2 p-6">
        <h2
          ...
          className="font-heading font-bold text-headline-md text-brand-navy"
        >
          Contact Party
        </h2>
