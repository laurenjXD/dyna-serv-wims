...
| 2.5 | Inventory picking and quantity verification | `08-outgoing-withdrawal-and-two-stage-commitment` | **Approved** (2026-08-06 direct post-picking dispatch amendment; pre-dispatch inspection removed) | In Progress — Stage 2 dispatch (`dispatchPickList`) completed 2026-08-20 after being found genuinely incomplete (placeholder transaction data, no balance decrement, no commitment execution); full fix + 3 review-confirmed findings (TOCTOU race, missing RLS UPDATE policies, AR document contract) all resolved and verified. Real-Postgres call-through-the-function integration testing still open (`tasks.md` Integration tests section) |
