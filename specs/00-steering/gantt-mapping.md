...
| 2.4 | FIFO/FEFO pick-list generation | `10-pick-list-and-acknowledgement-receipt` | **Approved** (2026-08-24 Master Inventory-backed pick-list field contract) | Implemented — Multi-item draft pick list builder & 10-column table workflow |
| 2.5 | Inventory picking and quantity verification | `08-outgoing-withdrawal-and-two-stage-commitment` | **Approved** (2026-08-06 direct post-picking dispatch amendment; 2026-08-24 dispatch-time barcode-scanning amendment, both approvals granted) | In Progress — Stage 2 dispatch completed, multi-item pick list drafting implemented, dispatch-time barcode scanning verified |
...
| VMI period close and financial documents | 45% | Shared PDF artifact pipeline | Four documents, Resend, payments, corrections, and E2E pass |
| Billing Overview / VMI workspace | 55% | Overview plus organization review | Existing ledger/contracts/SOA surfaces are reorganized into the office workflow and E.1-E.8 are usable |
