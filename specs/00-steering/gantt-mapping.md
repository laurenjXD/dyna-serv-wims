...
| 1.2 | Core inventory data model and database schema | 7/31 – 8/5 | 80% | `01-core-data-model` | **Draft** (requirements/design/testing complete; tasks.md missing only second sign-off) | Not Started (Blocked by Spec) |
