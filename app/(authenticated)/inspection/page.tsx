// Inspection Queue — superseded entry point.
//
// Sidebar/IA decision locked 2026-08-17 (see traceability below): Transfers
// and Inspection are no longer separate pages. The standalone "/inspection"
...
// for the still-real /inspection/[id] route) but no longer renders its own
// duplicate list — it forwards straight to the merged queue.
//
// Traceability:
...
//   specs/11-transfer-and-inspection/requirements.md R3, R3a
