...
| 1.4 | Receiving and inspection interface | 7/31 – 8/5 | 0% | `07-incoming-receiving`, `05-ui-shell` | **Draft** (`05` spec docs revised 2026-08-05: route inventory, floor/office shell behavior, outbound flow model, state catalog, capability keys, and all 8 decisions resolved — blocked on `02`/`03` approval and sign-off reviewers per tasks.md gate; `07` requirements/design fully drafted pending same) | Not Started (Blocked by Spec) |
...
| 1.6 | Internal inventory transfer requests | 8/6 – 8/11 | 0% | `11-transfer-and-inspection` | **Draft** (requirements/design fully drafted; blocked on `02`/`07` approval (`01` approved 2026-08-05)) | Not Started (Blocked by Spec) |
...
|---|---|---|---|---|
| 2.1 | Item category and subcategory management | `17-product-categorization-and-classification` | **Draft** (requirements/design fully drafted; blocked on `06` approval (`01` approved 2026-08-05)) | Not Started |
| 2.2 | Item classification and flow validation | `17-product-categorization-and-classification` | **Draft** (requirements/design fully drafted; blocked on `06` approval (`01` approved 2026-08-05)) | Not Started |
| 2.3 | Barcode and QR item identification | `18-barcode-integration` | **Spec Drafted** | Not Started |
| 2.4 | FIFO/FEFO pick-list generation | `10-pick-list-and-acknowledgement-receipt` | **Draft** (requirements/design fully drafted; blocked on `08`/`12`/`13` approval (`01` approved 2026-08-05)) | Not Started |
| 2.5 | Inventory picking and quantity verification | `08-outgoing-withdrawal-and-two-stage-commitment` | **Draft** (requirements/design fully drafted; blocked on `02`/`09`/`10` approval (`01` approved 2026-08-05)) | Not Started |
...
| 3.2 | Reorder-level and low-stock alerts | `14-notifications-and-alerts` | **Draft** (requirements/design fully drafted; blocked on `02`/`04` approval (`01` approved 2026-08-05)) | Not Started |
