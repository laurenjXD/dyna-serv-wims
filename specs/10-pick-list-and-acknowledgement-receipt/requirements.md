...
The Pick Lists queue exposes the committed document as **View / PDF**. Generation makes the list dispatch-ready; the document serves as the non-scan physical staging instruction before the sole QR scan gate at Dispatch.
